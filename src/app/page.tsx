...
import { Star, Trophy, ArrowUp, Flame, Gamepad2, CirclePlay } from 'lucide-react';
...
const page = () => {
  ...
  return (
    ...
    <Trophy className='w-22 h-22 text-accent-amber-500'/>
        <h1 className='text-5xl font-medium font-display'>Quiz Gol <br /> de Ouro</h1>
      </div>
      <p className='text-xl'>
      ...
      <div className='w-full p-4 rounded-2xl bg-surface-1 card-surface shadow-elevated border border-surface-2'>
        <ul className='flex flex-col text-xl gap-2 font-mono'>
          <li className='flex gap-3'><Star color='#E9B23E' />Nível: Craque</li>
          <li className='flex gap-3'><ArrowUp  color='#E9B23E' strokeWidth={2}/>XP Total: 620</li>
          <li className='flex gap-3'><Flame  color='#E9B23E' />Maior Sequência: 8</li>
          <li className='flex gap-3'><Gamepad2  color='#E9B23E' />Melhor Partida: 9/10</li>
        </ul>
      </div>
