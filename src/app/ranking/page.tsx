    ...
    <main className="mx-auto flex w-full max-w-6xl flex-col gap-4 pb-2">
        ...
        <div className="relative z-10 flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-text-secondary mt-1 text-sm">
              Painel com seus principais numeros da temporada.
            </p>
          </div>
      ...
      <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <article className="bg-surface-1 border-surface-2 shadow-elevated rounded-2xl border p-4">
          ...
          <p className="text-accent-amber-400 mt-2 font-mono text-3xl font-bold">
            {exp}
          </p>
        </article>
        ...
        <article className="bg-surface-1 border-surface-2 shadow-elevated rounded-2xl border p-4">
          ...
          <p className="mt-2 font-mono text-3xl font-bold">{best}/10</p>
        </article>

        <article className="bg-surface-1 border-surface-2 shadow-elevated rounded-2xl border p-4">
          <p className="text-text-secondary text-xs">Maior sequencia</p>
          <p className="mt-2 inline-flex items-center gap-2 font-mono text-3xl font-bold">
            <Flame className="text-accent-amber-400 h-6 w-6" />
            {bestStreak}
          </p>
        </article>
        ...
        <article className="bg-surface-1 border-surface-2 shadow-elevated rounded-2xl border p-4">
          ...
          <p className="mt-2 inline-flex items-center gap-2 font-mono text-3xl font-bold">
            <Target className="text-accent-amber-400 h-6 w-6" />
            {taxaAcertos}%
          </p>
        </article>
      </section>
      ...
      <section className="card-surface border-surface-2 border p-4 sm:p-5">
        <div className="mb-3 flex items-center justify-between">
          <div className="inline-flex items-center gap-2">
            <span className="bg-deep rounded-lg p-2">
              <Medal className="text-accent-amber-400 h-4 w-4" />
            </span>
            ...
            {results.map((result) => (
              <li
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-accent-amber-400 font-mono text-sm">
                    +{result.xpGanho} XP
                  </span>
                </div>
              </li>
        ...
        : <div className="bg-surface-1 border-surface-2 rounded-xl border px-4 py-8 text-center">
            ...
            <p className="mt-1 text-sm">
              Jogue uma partida para preencher seu historico.
            </p>
          </div>
        }
      </section>
